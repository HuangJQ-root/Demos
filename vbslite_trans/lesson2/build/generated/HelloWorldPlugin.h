...
MVBS_edatatype *MVBS_edatatype_create(void);

void MVBS_edatatype_delete(MVBS_edatatype *sample);
...
MVBS_arrayType *MVBS_arrayType_create(void);

void MVBS_arrayType_delete(MVBS_arrayType *sample);
...
MVBS_arrayType1 *MVBS_arrayType1_create(void);

void MVBS_arrayType1_delete(MVBS_arrayType1 *sample);
