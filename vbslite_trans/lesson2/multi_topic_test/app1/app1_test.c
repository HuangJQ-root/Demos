...
enum {
	reader_topic_index(MVBS_topic6),
	reader_topic_index(MVBS_topic7),
	reader_topic_index(MVBS_topic8),
	reader_topic_index(MVBS_topic9),
	reader_topic_index(MVBS_topic10),
};
...
static void MVBS_topic6_cb(void *sample)
{
	MVBS_HelloWorld1 *data = (MVBS_HelloWorld1*)sample;

	(void)data;
}

static void MVBS_topic7_cb(void *sample)
{
	MVBS_HelloWorld2 *data = (MVBS_HelloWorld2*)sample;

	(void)data;
}

static void MVBS_topic8_cb(void *sample)
{
	MVBS_HelloWorld3 *data = (MVBS_HelloWorld3*)sample;

	(void)data;
}

static void MVBS_topic9_cb(void *sample)
{
	MVBS_HelloWorld4 *data = (MVBS_HelloWorld4*)sample;

	(void)data;
}

static void MVBS_topic10_cb(void *sample)
{
	MVBS_HelloWorld5 *data = (MVBS_HelloWorld5*)sample;
...
static struct reader_meta_info subscriber_list[] = {
	READER_META_INFO(MVBS_topic6, MVBS_HelloWorld1, MVBS_topic6_cb, 100),
	READER_META_INFO(MVBS_topic7, MVBS_HelloWorld2, MVBS_topic7_cb, 100),
	READER_META_INFO(MVBS_topic8, MVBS_HelloWorld3, MVBS_topic8_cb, 100),
	READER_META_INFO(MVBS_topic9, MVBS_HelloWorld4, MVBS_topic9_cb, 100),
	READER_META_INFO(MVBS_topic10, MVBS_HelloWorld5, MVBS_topic10_cb, 100),
};
...
enum {
	writer_topic_index(MVBS_topic1),
	writer_topic_index(MVBS_topic2),
	writer_topic_index(MVBS_topic3),
	writer_topic_index(MVBS_topic4),
	writer_topic_index(MVBS_topic5),
};
...
static struct writer_meta_info publisher_list[] = {
	WRITER_META_INFO(MVBS_topic1, MVBS_HelloWorld, 100),
	WRITER_META_INFO(MVBS_topic2, MVBS_BasicTypeStruct, 100),
	WRITER_META_INFO(MVBS_topic3, MVBS_sdatatype, 100),
	WRITER_META_INFO(MVBS_topic4, MVBS_ComplexDataType, 100),
	WRITER_META_INFO(MVBS_topic5, StructSize50, 100),
};
