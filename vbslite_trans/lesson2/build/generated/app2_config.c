...
union union_of_all_topics {
	MVBS_HelloWorld1 __MVBS_HelloWorld1;
	MVBS_HelloWorld2 __MVBS_HelloWorld2;
	MVBS_HelloWorld3 __MVBS_HelloWorld3;
	MVBS_HelloWorld4 __MVBS_HelloWorld4;
	MVBS_HelloWorld5 __MVBS_HelloWorld5;
	MVBS_HelloWorld __MVBS_HelloWorld;
	MVBS_BasicTypeStruct __MVBS_BasicTypeStruct;
	MVBS_sdatatype __MVBS_sdatatype;
	MVBS_ComplexDataType __MVBS_ComplexDataType;
	StructSize50 __StructSize50;
};

extern const struct type_plugin MVBS_HelloWorld1_typeplugin;
extern const struct type_plugin MVBS_HelloWorld2_typeplugin;
extern const struct type_plugin MVBS_HelloWorld3_typeplugin;
extern const struct type_plugin MVBS_HelloWorld4_typeplugin;
extern const struct type_plugin MVBS_HelloWorld5_typeplugin;
extern const struct type_plugin MVBS_HelloWorld_typeplugin;
extern const struct type_plugin MVBS_BasicTypeStruct_typeplugin;
extern const struct type_plugin MVBS_sdatatype_typeplugin;
extern const struct type_plugin MVBS_ComplexDataType_typeplugin;
extern const struct type_plugin StructSize50_typeplugin;
...
static const struct reader_attr mvbs_reader_attrs[] = {
	...
	{
		.key	= "r2",
		.type	= &MVBS_BasicTypeStruct_typeplugin,
		.ptcp	= &mvbs_ptcp,
		.ep_attr = {
			.topic_name		= "MVBS_topic2",
			.type			= &MVBS_BasicTypeStruct_typeplugin,
			.agent_flag		= 0,
			.period_ms = 0,
			.qos = {
	...
	{
		.key	= "r3",
		.type	= &MVBS_sdatatype_typeplugin,
		.ptcp	= &mvbs_ptcp,
		.ep_attr = {
			.topic_name		= "MVBS_topic3",
			.type			= &MVBS_sdatatype_typeplugin,
			.agent_flag		= 0,
			.period_ms = 0,
			.qos = {
		...
		.max_matched_writers = 5,
	},
	{
		.key	= "r4",
		.type	= &MVBS_ComplexDataType_typeplugin,
		.ptcp	= &mvbs_ptcp,
		.ep_attr = {
			.topic_name		= "MVBS_topic4",
			.type			= &MVBS_ComplexDataType_typeplugin,
			.agent_flag		= 0,
			.period_ms = 0,
			.qos = {
	...
	{
		.key	= "r5",
		.type	= &StructSize50_typeplugin,
		.ptcp	= &mvbs_ptcp,
		.ep_attr = {
			.topic_name		= "MVBS_topic5",
			.type			= &StructSize50_typeplugin,
			.agent_flag		= 0,
			.period_ms = 0,
			.qos = {
...
static struct mvbs_reader_cache_change_eid_1 {
	struct mp_blk_hdr		hdr;
	struct reader_cache_change	cc;
	uint8_t				data[MVBS_BASICTYPESTRUCT_SIZE];
} mvbs_reader_history_eid_1[5];

static struct mvbs_reader_cache_change_eid_2 {
	struct mp_blk_hdr		hdr;
	struct reader_cache_change	cc;
	uint8_t				data[MVBS_SDATATYPE_SIZE];
} mvbs_reader_history_eid_2[5];

static struct mvbs_reader_cache_change_eid_3 {
	struct mp_blk_hdr		hdr;
	struct reader_cache_change	cc;
	uint8_t				data[MVBS_COMPLEXDATATYPE_SIZE];
} mvbs_reader_history_eid_3[5];

static struct mvbs_reader_cache_change_eid_4 {
	struct mp_blk_hdr		hdr;
	struct reader_cache_change	cc;
	uint8_t				data[STRUCTSIZE50_SIZE];
} mvbs_reader_history_eid_4[5];
...
static const struct writer_attr mvbs_writer_attrs[] = {
	{
		.key	= "w1",
		.type	= &MVBS_HelloWorld1_typeplugin,
		.ptcp	= &mvbs_ptcp,
		.ep_attr = {
			.topic_name		= "MVBS_topic6",
			.type			= &MVBS_HelloWorld1_typeplugin,
			.agent_flag		= 0,
			.period_ms = 0,
			.qos = {
	...
	{
		.key	= "w2",
		.type	= &MVBS_HelloWorld2_typeplugin,
		.ptcp	= &mvbs_ptcp,
		.ep_attr = {
			.topic_name		= "MVBS_topic7",
			.type			= &MVBS_HelloWorld2_typeplugin,
			.agent_flag		= 0,
			.period_ms = 0,
			.qos = {
	...
	{
		.key	= "w3",
		.type	= &MVBS_HelloWorld3_typeplugin,
		.ptcp	= &mvbs_ptcp,
		.ep_attr = {
			.topic_name		= "MVBS_topic8",
			.type			= &MVBS_HelloWorld3_typeplugin,
			.agent_flag		= 0,
			.period_ms = 0,
			.qos = {
	...
	{
		.key	= "w4",
		.type	= &MVBS_HelloWorld4_typeplugin,
		.ptcp	= &mvbs_ptcp,
		.ep_attr = {
			.topic_name		= "MVBS_topic9",
			.type			= &MVBS_HelloWorld4_typeplugin,
			.agent_flag		= 0,
			.period_ms = 0,
			.qos = {
	...
	{
		.key	= "w5",
		.type	= &MVBS_HelloWorld5_typeplugin,
		.ptcp	= &mvbs_ptcp,
		.ep_attr = {
			.topic_name		= "MVBS_topic10",
			.type			= &MVBS_HelloWorld5_typeplugin,
			.agent_flag		= 0,
			.period_ms = 0,
			.qos = {
...
static struct mvbs_writer_cache_change_eid_0 {
	...
	uint8_t				data[MVBS_HELLOWORLD1_SIZE];
} mvbs_writer_history_eid_0[5];

static struct mvbs_writer_cache_change_eid_1 {
	struct mp_blk_hdr		hdr;
	struct writer_cache_change	cc;
	uint8_t				data[MVBS_HELLOWORLD2_SIZE];
} mvbs_writer_history_eid_1[5];

static struct mvbs_writer_cache_change_eid_2 {
	struct mp_blk_hdr		hdr;
	struct writer_cache_change	cc;
	uint8_t				data[MVBS_HELLOWORLD3_SIZE];
} mvbs_writer_history_eid_2[5];

static struct mvbs_writer_cache_change_eid_3 {
	struct mp_blk_hdr		hdr;
	struct writer_cache_change	cc;
	uint8_t				data[MVBS_HELLOWORLD4_SIZE];
} mvbs_writer_history_eid_3[5];

static struct mvbs_writer_cache_change_eid_4 {
	struct mp_blk_hdr		hdr;
	struct writer_cache_change	cc;
	uint8_t				data[MVBS_HELLOWORLD5_SIZE];
} mvbs_writer_history_eid_4[5];
