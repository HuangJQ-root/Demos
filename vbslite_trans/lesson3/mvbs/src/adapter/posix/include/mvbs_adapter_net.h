...
typedef uint16_t	mvbs_socket_id_t;
...
/* Define the MTU Size of UDP */
#define MVBS_UDP_TXBUFSIZE			1500
#define MVBS_UDP_RXBUFSIZE			1500
...
/* Define the MTU Size of TCP */
#define MVBS_TCP_TXBUFSIZE			1522
#define MVBS_TCP_RXBUFSIZE			1522
